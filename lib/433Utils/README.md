...
Receiver PIN(default): GPIO.25(Physical 37)
Transmitter PIN(default): GPIO.24(Physical 35)
use 'gpio readall' to see PIN table
use '/home/pi/soft/lib/433Utils/RPi_utils' to change PIN numbers and recompile utilities
